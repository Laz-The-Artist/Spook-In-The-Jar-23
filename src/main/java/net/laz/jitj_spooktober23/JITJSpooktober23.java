package net.laz.jitj_spooktober23;

import com.mojang.logging.LogUtils;
import net.laz.jitj_spooktober23.block.ModBlockRegistry;
import net.laz.jitj_spooktober23.blockentity.ModBlockEntityRegistry;
import net.laz.jitj_spooktober23.blockentity.client.BrainJarBlockRenderer;
...
@Mod(JITJSpooktober23.MODID)
public class JITJSpooktober23 {

    public static final String MODID = "jitj_spooktober23";
    private static final Logger LOGGER = LogUtils.getLogger();

    public JITJSpooktober23()
    {
